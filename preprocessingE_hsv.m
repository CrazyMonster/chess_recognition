...
se1 = strel('rectangle', [10 3]);
se2 = strel('rectangle', [3 10]);
...
for i = 2 %1:size(ds.Labels, 1)
   ...
   subplot(1, 2, 2);
   imagesc(labels .* uint16(out)); axis image; colorbar;
